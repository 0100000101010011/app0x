!(function (e, t) {
  ...
  function S(e) {
    ...
    e = e.replace(k, '');
    var n = O.test(e);
    return n || j.test(e) ? E(e.slice(2), n ? 2 : 8) : x.test(e) ? y : +e;
  }
  var D = function (e, t, n) {
      ...
      return (
        ...
        M(n) &&
          ((d = !!n.leading),
          (a = (l = 'maxWait' in n) ? q(S(n.maxWait) || 0, t) : a),
          (f = 'trailing' in n ? !!n.trailing : f)),
        (g.cancel = function () {
          void 0 !== c && clearTimeout(c), (u = 0), (o = s = i = c = void 0);
        }),
        (g.flush = function () {
          return void 0 === c ? r : v(T());
        }),
        g
      );
    },
        ...
        B(e, [
          {
            ...
            value: function () {
              var e = Q();
              return !(!I.test(e) && !K.test(e.substr(0, 4)));
            },
          },
          {
            key: 'mobile',
      ...
      arguments.length > 0 &&
        ...
        ne &&
          ...
          (e = te).forEach(function (e, n) {
            var o = Z(e.node, 'mirror', t.mirror),
  ...
  return {
    init: function (e) {
      return (
        ...
        oe.disableMutationObserver || Y('[data-aos]', re),
        se(oe.disable) || ie()
          ? ce()
          : (document
              .querySelector('body')
            ...
            'DOMContentLoaded' === oe.startEvent &&
              ...
              ae(!0),
            window.addEventListener('resize', D(ae, oe.debounceDelay, !0)),
            window.addEventListener(
              'orientationchange',
              D(ae, oe.debounceDelay, !0)
            ),
            te)
      );
    },
